...
class UserTest {
    ...
    class BlockTests {
        @Test
        void givenTwoUsersThatFollowEachOther() {
            ...
            assertThat(userBob.getUsersYouFollow()).doesNotContain(userAlice);
            assertThat(userAlice.viewWall()).doesNotContain(userBob.getName());
            assertThat(userBob.getBlocked()).contains(userAlice);

            userAlice.follow(userBob);

            assertThat(userAlice.getUsersYouFollow()).doesNotContain(userBob);
        }
    }
